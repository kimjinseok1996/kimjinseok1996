...
### 🧩 Frontend
- **주요 프레임워크:** React, Vue 3
- **상태 관리 및 데이터 처리:** Zustand, React Query
...
### 📡 API & 기타 역량
- **REST API 연동:** Swagger 기반 문서 API 연동 경험
- **비동기 처리:** React Query 활용한 요청 처리 및 상태 분리
- **기술적 사고력:** 성능 병목 분석, 프로파일링, 구조 개선 고민 및 적용
